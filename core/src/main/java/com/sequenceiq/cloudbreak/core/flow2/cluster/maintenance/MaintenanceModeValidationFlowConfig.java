...
import static com.sequenceiq.cloudbreak.core.flow2.cluster.maintenance.MaintenanceModeValidationEvent.START_VALIDATION_EVENT;
...
import static com.sequenceiq.cloudbreak.core.flow2.cluster.maintenance.MaintenanceModeValidationEvent.VALIDATION_SOMETHING_WENT_WRONG;
...
public class MaintenanceModeValidationFlowConfig extends AbstractFlowConfiguration<MaintenanceModeValidationState, MaintenanceModeValidationEvent> {
    private static final List<Transition<MaintenanceModeValidationState, MaintenanceModeValidationEvent>> TRANSITIONS = new
            ...
            .from(VALIDATE_IMAGE_COMPATIBILITY_STATE).to(FINAL_STATE).event(VALIDATE_IMAGE_COMPATIBILITY_FINISHED_EVENT).defaultFailureEvent()
            .build();
