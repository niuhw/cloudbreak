...
CREATE SEQUENCE environment_id_seq START WITH 1
                                          INCREMENT BY 1
                                          NO MINVALUE
                                          NO MAXVALUE
                                          CACHE 1;

CREATE TABLE env_ldap (
...
CREATE INDEX idx_env_ldap_env_id ON env_ldap (env_id);

CREATE INDEX idx_env_ldap_ldap_id ON env_ldap (ldap_id);

-- //@UNDO
-- SQL to undo the change goes here.

-- DROP TABLE IF EXIST environment;
